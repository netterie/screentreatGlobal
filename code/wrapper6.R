...
model_version = 'usa_but_uga_stage-surv'
model_description = c(country='US',
                      data_stage='Galukunde 2015',
                      data_surv='Galukunde 2015',
                      data_treat='JNCI monograph',
                      data_other='',
                      ...
                      life_table='BMD',
                      other='usa but uga stage and surv')
