...
input_data_file = 'input_tza_barrier-nobarrier2.csv'
...
model_description = c(country='Tanzania',
                      ...
                      design='four trials: withoutER, withER, withERchemo, withERchemoERpos',
                      stages='early and advanced',
                      stageshift='From 85% to 60% advanced',
                      prognostic_factors='ERpos is 50%',
                      treatments='None, Tamoxifen, Chemo, Tam+Chemo',
                      efficacies='from EBCTCG',
                      life_table='IHME',
                      other='like _3bages30-49, but 50% ERpos and a 4th trial')
